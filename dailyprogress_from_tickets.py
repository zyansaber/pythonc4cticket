...
def main() -> None:
    ...
    current_tickets = _normalize_ticket_map(_as_ticket_map(db.reference(f"{CURRENT_ROOT}/tickets").get()))
    previous_tickets = _normalize_ticket_map(_as_ticket_map(db.reference(f"{PREVIOUS_ROOT}/tickets").get()))
